    ...
    <div className="change-avatar-container">
      ...
      >
        <div className="select-image-header">
          ...
          <IoCloseOutline className="close-icon-image-selector" onClick={e => exitChangeAvatar()}/>
        </div>
      ...
      <div className="avatar-cancel-apply">
          <div style={{marginLeft: '40px', color: "#f2f3f5", cursor: "pointer"}} onClick={e => exitChangeAvatar()}>Cancel</div>
          <button type="submit" className="apply-avatar" form="change-avatar-form">Apply</button>
        </div>
    </div>
  );
}
